                ...
                <Grid is_flex>
                    <Grid>
                        ...
                        <Grid>
                            <Image
                                shape="rectangle"
                                src={imagePreview ? imagePreview : "https://thesocialstudies.co/wp-content/uploads/2021/06/placeholder-1-1.jpg"}
                            />
                        </Grid>
                    ...
                    <Grid margin="10px">
                        {/* 제품 타이틀 */}
                        <Grid is_flex>
                            <Text width="100px" bold>제품명</Text>
                            <Input
                                width="100%"
                        ...
                        {/* 제품 스펙 */}
                        <Grid is_flex>
                            <Text width="100px" bold>스펙</Text>
                            <Input
                                width="100%"
                                _onChange={changeSpec}
                            />
                        </Grid>
                        {/* 제품 추천 공간 */}
                        <Grid is_flex>
                            <Text width="100px" bold>추천 공간</Text>
                            <Input
                                width="100%"
                                _onChange={changePlace}
                            />
                        </Grid>
                        {/* 제품 설명 */}
                        <Grid is_flex>
                            <Text width="100px" bold>제품 설명</Text>
                            <Input
                                width="100%"
